...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
            ...
            for j in range(cell[1] - 1, cell[1] + 2):
                ...
                if 0 <= i < self.height and 0 <= j < self.width:
                    if (i, j) not in self.safes and (i, j) not in self.mines:
                        ...
                        # we already know it's a mine, so decrement count
                        count -= 1
        ...
        while updated:
            ...
            # a) Collect safes/mines from all sentences
            all_safes = set()
            all_mines = set()
            for sentence in self.knowledge:
            ...
            # b) Mark them in our AI, which also updates sentences
            ...
            # d) Clean out any empty sentences
